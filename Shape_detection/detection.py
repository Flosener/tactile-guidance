...
def draw_categories():
    ...
    directory = r"D:/WWU/M8 - Master Thesis/Project/Code/"
    file_path = f"{directory}drawing order_{participant_ID}.txt"
    with open(file_path, 'w') as file:  
        ...
        for category, items in categories.items():
            ...
            for index, item in enumerate(items):
                ...
                # one minute pause after every 10 figures
                '''total_figures += 1
...
if __name__ == "__main__":
    ...
    # Now you can use these values in your new code
    '''print(f"Loaded data for Participant {participant_ID}:")
    print(f"Preference: {preference}")
    print(f"Top Intensity: {int_top}")
    print(f"Bottom Intensity: {int_bottom}")
    print(f"Left Intensity: {int_left}")
    print(f"Right Intensity: {int_right}")
    print(f"Average Intensity: {avg_int}")'''
